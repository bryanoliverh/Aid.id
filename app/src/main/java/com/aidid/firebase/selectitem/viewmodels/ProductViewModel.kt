...
class ProductViewModel : ViewModel(){
    ...
    fun fetchDummyProduct(){
        ...
        val dummies = mutableListOf<Product>().apply {
            add(Product(1, "Surgical Mask 3-ply 1Box (50pcs)", 5, "https://images-na.ssl-images-amazon.com/images/I/81zKjnsKyZL._AC_SL1500_.jpg"))
            add(Product(2, "N95 Mask 1Box (20pcs)", 7, "https://content.pattersondental.com/items/LargeSquare/images/222584.jpg"))
            add(Product(3, "APD Type 1412 (per pcs)", 20, "https://cf.shopee.co.id/file/6a29e2d183f31b3f8e3c8fd5f9a8dc79"))
            add(Product(4, "PPE Face Shield (per 20 pcs)", 5, "https://cdn.shopify.com/s/files/1/0013/1655/2764/products/DB-Face-Shild.jpg?v=1593785175"))
            add(Product(5, "Hospital Bed", 150, "https://ecs7.tokopedia.net/img/cache/700/product-1/2017/1/19/15782036/15782036_6f26aa1c-634e-48a0-9f97-4b12fd9668d8_1454_1025.jpg"))
            add(Product(6, "Reintair by Casals Air Purifier Covid 19", 150, "https://www.casals.com/assets/uploads/cat_pdf/normal_1f16e-reintair_300-600.jpg"))
            add(Product(7, "Hepa Filter Air Flow", 150, "https://labtech-indonesia.com/wp-content/uploads/2017/04/filter.png"))
        }
